...
llm_prompt = PromptTemplate.from_template(
    "You are experineced personal stylist. Please, describe appropriate style look taking into account that info: {text}?"
)

from langchain.memory import ConversationBufferWindowMemory
memoryT = ConversationBufferWindowMemory(k=5)
